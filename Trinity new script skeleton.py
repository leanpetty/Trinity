...
def everydaylifeT():
    ...
    if event7==0:
        ...
        print("There was a bad flood this week. You have lost 4% of your population. Your current population is", Tpop, ".")
    else:
        input
    ...
    if event8==0:
        ...
        #CHANGE POP NAME FOR EACH CLAN
        print("There was a big fire this week. You have lost 8% of your population. Your current population is", Tpop, ".")
    else:
        input
